...
if 'vacation_status' in db.classes :
    v1 = db.vacation_status.create (name = 'open',             order = 1)
    v2 = db.vacation_status.create (name = 'submitted',        order = 2)
    v3 = db.vacation_status.create (name = 'accepted',         order = 3)
    v4 = db.vacation_status.create (name = 'declined',         order = 4)
    v5 = db.vacation_status.create (name = 'cancel requested', order = 5)
    v6 = db.vacation_status.create (name = 'cancelled',        order = 6)
    db.vacation_status.set (v1, transitions = [v2])
    db.vacation_status.set (v2, transitions = [v1, v3, v4])
    db.vacation_status.set (v3, transitions = [v5])
    db.vacation_status.set (v5, transitions = [v3, v6])
