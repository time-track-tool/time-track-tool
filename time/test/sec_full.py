...
Role "user":
 ...
 User is allowed to edit (some of) their own user details (Edit for "user": ('password', 'realname', 'phone', 'private_phone', 'external_phone', 'quick_dialling', 'internal_phone', 'private_mobile', 'private_phone_visible', 'private_mobile_visible', 'substitute', 'subst_active', 'title', 'queries', 'lunch_start', 'lunch_duration', 'room', 'timezone', 'tt_lines') only)
