...
Role "external":
 ...
 User may access the web interface (Web Access)
 User may use the email interface (Email Access)
 Users are allowed to access issue if their external company has access (Edit for "issue": ['id', 'activity', 'actor', 'creation', 'creator', 'files', 'composed_of', 'planned_begin', 'depends', 'planned_end', 'deadline', 'keywords', 'category', 'needs', 'severity', 'area', 'responsible', 'priority', 'files_affected', 'doc_issue_status', 'fixed_in', 'cur_est_end', 'superseder', 'earliest_start', 'part_of', 'closed', 'cur_est_begin', 'kind', 'numeric_effort', 'nosy', 'title', 'messages', 'status', 'maturity_index', 'release', 'effective_prio'] only)
 Users are allowed to access issue if their external company has access (View for "issue": ['id', 'activity', 'actor', 'creation', 'creator', 'files', 'composed_of', 'planned_begin', 'depends', 'planned_end', 'deadline', 'keywords', 'category', 'needs', 'severity', 'area', 'responsible', 'priority', 'files_affected', 'doc_issue_status', 'fixed_in', 'cur_est_end', 'superseder', 'earliest_start', 'part_of', 'closed', 'cur_est_begin', 'kind', 'numeric_effort', 'nosy', 'title', 'messages', 'status', 'maturity_index', 'release', 'effective_prio'] only)
...
Role "user":
  (Search for "time_project": ('name', 'description', 'responsible', 'deputy', 'organisation', 'status', 'work_location', 'op_project', 'overtime_reduction', 'id', 'is_public_holiday', 'creation', 'creator', 'activity', 'actor', 'cost_center') only)
 ...
 User is allowed to view selected fields if booking is allowed for at least one work package for this user (View for "time_project": ('name', 'description', 'responsible', 'deputy', 'organisation', 'status', 'work_location', 'op_project', 'overtime_reduction', 'id', 'is_public_holiday', 'creation', 'creator', 'activity', 'actor', 'cost_center') only)
