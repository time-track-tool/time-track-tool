...
Role "ituser":
 ...
 User is allowed to access it_issue if on nosy list (Edit for "it_issue": ('confidential', 'deadline', 'title') only)
 ...
 Users are allowed to view their own and public queries (View for "query" only)
