...
Role "user":
 ...
 Users are allowed if they have one of the view roles of the purchase type (Edit for "purchase_request": ('frame_purchase', 'frame_purchase_end', 'internal_order', 'messages', 'nosy', 'purchasing_agents', 'sap_reference', 'terms_conditions') only)
