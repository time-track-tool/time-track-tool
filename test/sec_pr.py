...
Role "user":
 ...
 Users are allowed if they have one of the view roles of the purchase type or one of the (forced) approval roles (Edit for "purchase_request": ('frame_purchase', 'frame_purchase_end', 'internal_order', 'messages', 'nosy', 'payment_type', 'purchasing_agents', 'sap_reference', 'special_approval', 'terms_conditions') only)
