...
Role "hr":
 ...
 User may access dynamic user record because the org_location is allowed (Edit for "user_dynamic": ('aux_org_locations', 'time_activity_perm') only)
...
Role "office":
  (Restore for "room" only)
  (Retire for "room" only)
 User is allowed Edit on (Edit for "user": ('title', 'room', 'position_text') only)
...
Role "user":
 ...
 User is allowed to edit (some of) their own user details (Edit for "user": ('lunch_duration', 'lunch_start', 'password', 'queries', 'realname', 'room', 'subst_active', 'substitute', 'timezone', 'tt_lines') only)
