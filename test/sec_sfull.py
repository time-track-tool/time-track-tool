...
Role "it":
 ...
 User is allowed Edit on (Edit for "user": ('address', 'alternate_addresses', 'nickname', 'password', 'timezone', 'username') only)
 User is allowed Edit on (Edit for "user": ('aux_username', 'group', 'home_directory', 'is_lotus_user', 'login_shell', 'samba_home_drive', 'samba_home_path', 'samba_kickoff_time', 'samba_lm_password', 'samba_logon_script', 'samba_nt_password', 'samba_profile_path', 'samba_pwd_can_change', 'samba_pwd_last_set', 'samba_pwd_must_change', 'secondary_groups', 'shadow_expire', 'shadow_inactive', 'shadow_last_change', 'shadow_max', 'shadow_min', 'shadow_used', 'shadow_warning', 'sync_with_ldap', 'uid', 'user_password') only)
