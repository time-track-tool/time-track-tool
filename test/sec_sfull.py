...
Role "controlling":
 User is allowed Edit on (Edit for "daily_record": ('attendance_record', 'status', 'time_record') only)
 ...
 User is allowed to access attendance_record (View for "attendance_record" only)
 ...
 User is allowed to edit attendance_record (Edit for "attendance_record" only)
...
Role "hr-org-location":
  (Search for "attendance_record" only)
 ...
 User is allowed to view record data if he/she is in group HR-Org-Location and in the same Org-Location as the given user (View for "attendance_record" only)
 User is allowed to view record data if he/she is in group HR-Org-Location and in the same Org-Location as the given user (View for "time_record" only)
Role "hr-vacation":
 User is allowed to access contract_type (View for "contract_type" only)
 User is allowed to access leave_submission (View for "leave_submission" only)
 User is allowed to access vacation_correction (View for "vacation_correction" only)
...
Role "user":
  (Search for "daily_record_freeze" only)
  (Search for "sap_cc" only)
  (Search for "time_project" only)
  (Search for "time_record" only)
  ...
  (Search for "user_dynamic" only)
  (Search for "vacation_correction" only)
 ...
 User is allowed to search time_wp (Search for "time_wp": ('activity', 'actor', 'auto_wp', 'cost_center', 'creation', 'creator', 'description', 'durations_allowed', 'epic_key', 'has_expiration_date', 'id', 'is_extern', 'is_public', 'name', 'project', 'responsible', 'time_end', 'time_start', 'time_wp_summary_no', 'wp_no') only)
