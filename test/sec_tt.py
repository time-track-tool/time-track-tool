...
Role "controlling":
 ...
 User is allowed to create cc_bu_category (Create for "cc_bu_category" only)
 ...
 User is allowed to create sap_cc_category (Create for "sap_cc_category" only)
 ...
 User is allowed to edit cc_bu_category (Edit for "cc_bu_category" only)
 ...
 User is allowed to edit sap_cc_category (Edit for "sap_cc_category" only)
 ...
 User may access dynamic user record because the org_location is allowed (View for "user_dynamic": ('id', 'sap_cc', 'user', 'valid_from', 'valid_to') only)
 ...
 User may access item because org_location in dynamic user is allowed (View for "daily_record" only)
 ...
 User may access item because org_location in dynamic user is allowed (View for "vacation_correction" only)
 User may access sap cost center because organisation is allowed (Edit for "sap_cc" only)
 User may access time category because organisation is allowed (Edit for "time_project": ('group_lead', 'nosy', 'team_lead') only)
 ...
 User may access work package because organisation is allowed (Edit for "time_wp": ('project',) only)
 User may access work package because organisation is allowed (View for "time_wp" only)
Role "doc_admin":
...
Role "dom-user-edit-hr":
 ...
 User is allowed to edit user_contact (Edit for "user_contact" only)
 Users may view user_dynamic records for ad_domain for which they are in the domain_permission for the user (View for "user_dynamic" only)
 Users may view/edit user records for ad_domain for which they are in the domain_permission for the user (Edit for "user": ['clearance_by', 'csv_delimiter', 'hide_message_files', 'lunch_duration', 'lunch_start', 'reduced_activity_list', 'roles', 'room', 'subst_active', 'substitute', 'timezone', 'tt_lines'] only)
 Users may view/edit user records for ad_domain for which they are in the domain_permission for the user (View for "user": ['clearance_by', 'csv_delimiter', 'hide_message_files', 'lunch_duration', 'lunch_start', 'reduced_activity_list', 'roles', 'room', 'subst_active', 'substitute', 'timezone', 'tt_lines'] only)
...
Role "hr":
 ...
 User is allowed to search auto_wp (Search for "auto_wp" only)
 User may access attendance_record because org_location in dynamic user is allowed (Edit for "attendance_record" only)
 User may access attendance_record because org_location in dynamic user is allowed (View for "attendance_record" only)
...
Role "hr-vacation":
 ...
 User may access item because org_location in dynamic user is allowed (Edit for "leave_submission" only)
 User may access item because org_location in dynamic user is allowed (Edit for "vacation_correction" only)
 User may access item because org_location in dynamic user is allowed (View for "leave_submission" only)
 User may access item because org_location in dynamic user is allowed (View for "vacation_correction" only)
Role "it":
...
Role "project":
 ...
 User may access time category because organisation is allowed (Edit for "time_project": ('infosec_req', 'is_extern', 'max_hours', 'op_project', 'planned_effort', 'product_family', 'project_type', 'reporting_group', 'work_location') only)
 User may access time category because organisation is allowed (View for "time_project" only)
 User may access time_wp_group because organisation of time category is allowed (Edit for "time_wp_group" only)
 User may access work package because organisation is allowed (Edit for "time_wp" only)
 User may access work package because organisation is allowed (View for "time_wp" only)
Role "project_view":
 User is allowed to access time_report (View for "time_report" only)
 User may access time category because organisation is allowed (View for "time_project" only)
...
Role "user":
 ...
 User is allowed to access cc_bu_category (View for "cc_bu_category" only)
 User is allowed to access contract_type (View for "contract_type" only)
 ...
 User is allowed to access daily record if he is owner or supervisor or timetracking-by user (Edit for "daily_record": ('attendance_record', 'status', 'time_record') only)
 ...
 User is allowed to access sap_cc_category (View for "sap_cc_category" only)
 ...
 User is allowed to edit (some of) their own user details (Edit for "user": ('dark_mode',) only)
 User is allowed to edit doc (Edit for "doc" only)
 ...
 User is allowed to edit workpackage if he is time category owner or deputy (Edit for "time_wp": ('allowed_olo', 'cost_center', 'is_public', 'name', 'responsible', 'time_wp_summary_no', 'wp_no') only)
 User is allowed to retire their queries (Retire for "query" only)
 User is allowed to search attendance_record (Search for "attendance_record" only)
 User is allowed to search daily_record (Search for "daily_record" only)
 User is allowed to search daily_record_freeze (Search for "daily_record_freeze" only)
 ...
 User is allowed to search time_wp (Search for "time_wp" only)
 User is allowed to search user_dynamic (Search for "user_dynamic" only)
 User is allowed to search user_status (Search for "user": ('status',) only)
 User is allowed to search vacation_correction (Search for "vacation_correction" only)
 User is allowed to see time record if User may view a daily_record (and time_records that are attached to that daily_record) if the user owns the daily_record or has role \'HR\' or \'Controlling\', or the user is supervisor or substitute supervisor of the owner of the daily record (the supervisor relationship is transitive) or the owner of the daily record. If user has role HR-Org-Location and is in the same Org-Location as the record, it may also be seen (View for "attendance_record" only)
 ...
 User is allowed to view record if he is the supervisor or the person to whom approvals are delegated (View for "time_record" only)
 User is allowed to view selected fields in work package if booking is allowed for this user (also applies to timetracking by, supervisor and approval delegated) (View for "time_wp": ('activity', 'actor', 'allowed_olo', 'cost_center', 'creation', 'creator', 'description', 'durations_allowed', 'epic_key', 'has_expiration_date', 'id', 'is_extern', 'is_public', 'name', 'project', 'responsible', 'time_end', 'time_start', 'time_wp_summary_no', 'wp_no') only)
 ...
 User is allowed to view work package names if he/she has role HR or HR-Org-Location (View for "time_wp": ('name', 'project') only)
 User is allowed to view/edit workpackage if he is owner or project responsible/deputy (Edit for "time_wp": ('allowed_olo', 'bookers', 'description', 'epic_key', 'planned_effort', 'time_end', 'time_start', 'time_wp_summary_no') only)
 User may access sap cost center because organisation is allowed (View for "sap_cc" only)
 User may access the rest interface (Rest Access)
 User may access the web interface (Web Access)
 User may access the xmlrpc interface (Xmlrpc Access)
 User may access time category because organisation is allowed (View for "time_project": ('activity', 'actor', 'creation', 'creator', 'deputy', 'description', 'id', 'is_extern', 'is_public_holiday', 'is_special_leave', 'is_vacation', 'max_hours', 'name', 'no_overtime', 'no_overtime_day', 'nosy', 'only_hours', 'op_project', 'overtime_reduction', 'responsible', 'status', 'work_location', 'wps') only)
 ...
 User may see time report if reponsible or deputy of time category or on nosy list of time category (View for "time_report" only)
 User may use the email interface (Email Access)
 ...
 User may view their own user dynamic (View for "user_dynamic" only)
 User may view their own user functional role (View for "user_functional_role" only)
 User may view their own vacation corrections (View for "vacation_correction" only)
 ...
 User or Timetracking by user may edit records owned by user (Edit for "attendance_record" only)
 User or Timetracking by user may edit records owned by user (Edit for "time_record" only)
 User or Timetracking by user may edit records owned by user (Restore for "attendance_record" only)
 User or Timetracking by user may edit records owned by user (Restore for "time_record" only)
 User or Timetracking by user may edit records owned by user (Retire for "attendance_record" only)
 User or Timetracking by user may edit records owned by user (Retire for "time_record" only)
 User or Timetracking by user may edit records owned by user (View for "attendance_record" only)
 User or Timetracking by user may edit records owned by user (View for "time_record" only)
