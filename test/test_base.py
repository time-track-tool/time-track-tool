...
# Get some html functions from extensions
sys.path.insert (1, 'extensions')
sys.path.insert (1, 'lib')
from extensions.vac import vacation_with_status, remaining_vacation
from extensions.vac import eoy_vacation

from vacation import vacation_time_sum
...
class Test_Case_Support_Timetracker (_Test_Case, unittest.TestCase):
    ...
    roles = \
        ...
        , 'procurement', 'project', 'project_view', 'sec-incident-nosy'
...
class Test_Case_Timetracker (_Test_Case_Summary, unittest.TestCase):
    ...
    def test_user13_vacation (self):
        ...
        self.assertEqual (lines  [1] [2], '25.000')
        self.assertEqual (lines  [1] [3], '25.000')
        self.assertEqual (lines  [1] [4], '7.270')
        self.assertEqual (lines  [1] [5], '32.270')
        self.assertEqual (lines  [1] [6], '23.0')
        self.assertEqual (lines  [1] [7], '7.270')
        self.assertEqual (lines  [1] [8], '9.270')
        self.assertEqual (lines  [1] [9], '0.000')
        self.assertEqual (lines  [2] [0], 'testuser13')
        self.assertEqual (lines  [2] [1], '2015-12-31')
        self.assertEqual (lines  [2] [2], '25.000')
        self.assertEqual (lines  [2] [3], '25.000')
        self.assertEqual (lines  [2] [4], '9.270')
        self.assertEqual (lines  [2] [5], '34.270')
        self.assertEqual (lines  [2] [6], '0.0')
        self.assertEqual (lines  [2] [7], '')
        self.assertEqual (lines  [2] [8], '34.270')
        self.assertEqual (lines  [2] [9], '0.000')
    ...
    def test_user15_19_vac_monthly (self):
        ...
        self.assertEqual (lines  [1] [2], '30.000')
        self.assertEqual (lines  [1] [3], '15.000')
        self.assertEqual (lines  [1] [4], '0.000')
        self.assertEqual (lines  [1] [5], '15.000')
        self.assertEqual (lines  [1] [6], '0.0')
        self.assertEqual (lines  [1] [7], '0.000')
        self.assertEqual (lines  [1] [8], '15.000')
        self.assertEqual (lines  [2] [0], 'testuser16')
        self.assertEqual (lines  [2] [1], '2018-12-31')
        self.assertEqual (lines  [2] [2], '30.000')
        self.assertEqual (lines  [2] [3], '15.000')
        self.assertEqual (lines  [2] [4], '0.000')
        self.assertEqual (lines  [2] [5], '15.000')
        self.assertEqual (lines  [2] [6], '0.0')
        self.assertEqual (lines  [2] [7], '0.000')
        self.assertEqual (lines  [2] [8], '15.000')
        self.assertEqual (lines  [3] [0], 'testuser17')
        self.assertEqual (lines  [3] [1], '2018-12-31')
        self.assertEqual (lines  [3] [2], '30.000')
        self.assertEqual (lines  [3] [3], '30.000')
        self.assertEqual (lines  [3] [4], '1.000')
        self.assertEqual (lines  [3] [5], '31.000')
        self.assertEqual (lines  [3] [6], '0.0')
        self.assertEqual (lines  [3] [7], '1.000')
        self.assertEqual (lines  [3] [8], '31.000')
        self.assertEqual (lines  [4] [0], 'testuser18')
        self.assertEqual (lines  [4] [1], '2018-12-31')
        self.assertEqual (lines  [4] [2], '30.000')
        self.assertEqual (lines  [4] [3], '12.500')
        self.assertEqual (lines  [4] [4], '0.000')
        self.assertEqual (lines  [4] [5], '12.500')
        self.assertEqual (lines  [4] [6], '0.0')
        self.assertEqual (lines  [4] [7], '0.000')
        self.assertEqual (lines  [4] [8], '12.500')
        self.assertEqual (lines  [5] [0], 'testuser19')
        self.assertEqual (lines  [5] [1], '2018-12-31')
        self.assertEqual (lines  [5] [2], '30.000')
        self.assertEqual (lines  [5] [3], '17.500')
        self.assertEqual (lines  [5] [4], '0.000')
        self.assertEqual (lines  [5] [5], '17.500')
        self.assertEqual (lines  [5] [6], '0.0')
        self.assertEqual (lines  [5] [7], '0.000')
        self.assertEqual (lines  [5] [8], '17.500')
        fs = { 'user': self.uid_by_name.values ()
        ...
        self.assertEqual (lines  [1] [2], '30.000')
        self.assertEqual (lines  [1] [3], '30.000')
        self.assertEqual (lines  [1] [4], '31.000')
        self.assertEqual (lines  [1] [5], '61.000')
        self.assertEqual (lines  [1] [6], '0.0')
        self.assertEqual (lines  [1] [7], '')
        self.assertEqual (lines  [1] [8], '61.000')
        self.assertEqual (lines  [2] [0], 'testuser18')
        self.assertEqual (lines  [2] [1], '2019-12-31')
        self.assertEqual (lines  [2] [2], '30.000')
        self.assertEqual (lines  [2] [3], '2.500')
        self.assertEqual (lines  [2] [4], '12.500')
        self.assertEqual (lines  [2] [5], '15.000')
        self.assertEqual (lines  [2] [6], '0.0')
        self.assertEqual (lines  [2] [7], '')
        self.assertEqual (lines  [2] [8], '15.000')
        ...
        self.assertEqual (lines  [3] [2], '30.000')
        self.assertEqual (lines  [3] [3], '30.000')
        self.assertEqual (lines  [3] [4], '17.500')
        self.assertEqual (lines  [3] [5], '47.500')
        self.assertEqual (lines  [3] [6], '0.0')
        self.assertEqual (lines  [3] [7], '')
        self.assertEqual (lines  [3] [8], '47.500')
        ...
        self.assertEqual (lines  [1] [2], '30.000')
        self.assertEqual (lines  [1] [3], '2.500')
        self.assertEqual (lines  [1] [4], '31.000')
        self.assertEqual (lines  [1] [5], '33.500')
        self.assertEqual (lines  [1] [6], '0.0')
        self.assertEqual (lines  [1] [7], '')
        self.assertEqual (lines  [1] [8], '33.500')
        self.assertEqual (lines  [2] [0], 'testuser18')
        ...
        self.assertEqual (lines  [3] [2], '30.000')
        self.assertEqual (lines  [3] [3], '5.000')
        self.assertEqual (lines  [3] [4], '17.500')
        self.assertEqual (lines  [3] [5], '22.500')
        self.assertEqual (lines  [3] [6], '0.0')
        self.assertEqual (lines  [3] [7], '')
        self.assertEqual (lines  [3] [8], '22.500')
    ...
    def test_user14_vacation (self):
        ...
        self.assertEqual (lines  [1] [5], '16.369')
        self.assertEqual (lines  [1] [6], '10.0')
        self.assertEqual (lines  [1] [7], '6.027')
        self.assertEqual (lines  [1] [8], '6.369')
        self.assertEqual (lines  [1] [9], '0.000')
        self.db.close  ()
        ...
        self.assertEqual (lines  [1] [3], '10.342')
        self.assertEqual (lines  [1] [4], '6.027')
        self.assertEqual (lines  [1] [5], '17.000')
        self.assertEqual (lines  [1] [6], '10.000')
        self.assertEqual (lines  [1] [7], '6.027')
        self.assertEqual (lines  [1] [8], '7.000')
        self.assertEqual (lines  [1] [9], '0.000')
    ...
    def test_user23 (self):
        ...
        self.db.close ()
        self.db = self.tracker.open ('admin')
        self.monkey_patch_auto_wp_auditors ()
        user23_time.import_data_23 (self.db, self.user23, self.olo, self)
        self.db.commit ()
        # Restore detectors
        self.restore_monkey_patched_detectors ()
        self.db.close ()
        self.db = self.tracker.open (self.username0)
    ...
    def monkey_patch_auto_wp_auditors (self):
        """ We don't want auditors for auto-wp to fire during import
            Monkey-patch the detector list to remove auto wp checks
        """
        self.old_priolist_wp = self.db.time_wp.auditors ['create']
        pl = deepcopy (self.old_priolist_wp)
    ...
    # end def monkey_patch_auto_wp_auditors

    def monkey_patch_pub_holiday_reactors (self):
        """ We need to import the data *before* we create public
            holidays, otherwise the time records for these would be
            created during import
        """
        self.old_priolist_ph = self.db.public_holiday.reactors ['create']
        pl = deepcopy (self.old_priolist_ph)
        # Priolist has (prio, name, function) tuples
        for i, item in enumerate (pl.list):
    ...
    # end def monkey_patch_pub_holiday_reactors

    def restore_monkey_patched_detectors (self):
        # Restore detectors
        if getattr (self, 'old_priolist_wp', None):
            self.db.time_wp.auditors        ['create'] = self.old_priolist_wp
            self.old_priolist_wp = None
        if getattr (self, 'old_priolist_ph', None):
            self.db.public_holiday.reactors ['create'] = self.old_priolist_ph
            self.old_priolist_ph = None
    # end def restore_monkey_patched_detectors
    ...
    def setup_user24 (self):
        ...
        self.monkey_patch_auto_wp_auditors ()
        self.monkey_patch_pub_holiday_reactors ()
    ...
    def test_user27 (self):
        ...
        self.assertEqual (lines  [1] [2], '30.000')
        self.assertEqual (lines  [1] [3], '7.500')
        self.assertEqual (lines  [1] [4], '27.500')
        self.assertEqual (lines  [1] [5], '35.000')
        self.assertEqual (lines  [1] [6], '7.0')
        self.assertEqual (lines  [1] [7], '0.000')
        self.assertEqual (lines  [1] [8], '28.000')
        self.assertEqual (lines  [2] [0], 'testuser27')
        self.assertEqual (lines  [2] [1], '2023-12-31')
        self.assertEqual (lines  [2] [2], '30.000')
        self.assertEqual (lines  [2] [3], '7.500')
        self.assertEqual (lines  [2] [4], '0.000')
        self.assertEqual (lines  [2] [5], '7.500')
        self.assertEqual (lines  [2] [6], '0.0')
        self.assertEqual (lines  [2] [7], '0.000')
        self.assertEqual (lines  [2] [8], '7.500')
        self.assertEqual (lines  [3] [0], 'testuser27 / part time')
        self.assertEqual (lines  [3] [1], '2022-12-31')
        self.assertEqual (lines  [3] [2], '24.000')
        self.assertEqual (lines  [3] [3], '10.000')
        self.assertEqual (lines  [3] [4], '0.000')
        self.assertEqual (lines  [3] [5], '10.000')
        self.assertEqual (lines  [3] [6], '8.0')
        self.assertEqual (lines  [3] [7], '0.000')
        self.assertEqual (lines  [3] [8], '2.000')
        self.assertEqual (lines  [4] [0], 'testuser27 / part time')
        self.assertEqual (lines  [4] [1], '2023-12-31')
        self.assertEqual (lines  [4] [2], '24.000')
        self.assertEqual (lines  [4] [3], '16.000')
        self.assertEqual (lines  [4] [4], '2.000')
        self.assertEqual (lines  [4] [5], '18.000')
        self.assertEqual (lines  [4] [6], '2.0')
        self.assertEqual (lines  [4] [7], '')
        self.assertEqual (lines  [4] [8], '16.000')
    ...
    def setup_user28 (self):
        ...
        self.user28 = self.db.user.create \
            ...
            , lastname     = 'User28'
            , supervisor   = self.user0
            , address      = 'testuser28@example.com'
            )
        self.db.time_wp.set ('44', bookers = [self.user28])
        self.monkey_patch_pub_holiday_reactors ()
        user28_time.import_data_28 (self.db, self.user28, self.olo, self)
        # We need the public holidays in Dec
        self.db.public_holiday.create \
            ( date        = date.Date ('2023-12-08')
            , description = 'Maria Empfängis'
        ...
        # Restore detectors
        self.restore_monkey_patched_detectors ()
    # end def setup_user28

    def test_user28 (self):
        ...
        #self.db = self.tracker.open (self.username0)
        #ud = self.db.user_dynamic.filter \
        #    (None, dict (user = self.user28, valid_to = '2023-11-30'))
        #assert len (ud) == 1
        #dt = date.Date ('2023-12-01')
        #self.db.user_dynamic.set (ud [0], valid_to = dt)
        #self.db.commit ()
        #self.db.close ()
        self.db = self.tracker.open (self.username0)
        dyn = user_dynamic.last_user_dynamic (self.db, self.user28)
        dt  = date.Date ('2023-08-01')
        self.db.user_dynamic.set (dyn.id, valid_from = dt)
        self.db.commit ()
        self.db.close ()
    # end def test_user28
    ...
    def setup_user30 (self):
        self.username30 = 'testuser30'
        self.user30 = self.db.user.create \
            ( username     = self.username30
            , firstname    = 'Nummer30'
            , lastname     = 'User30'
            )
        # Allow user to create their own dyn user rec
        self.db.o_permission.create \
            (user = self.user30, org_location = [self.olo, self.olo2])
        p = self.db.overtime_period.create \
            ( name              = 'monthly average required'
            , months            = 1
            , weekly            = False
        ...
        # allow user30 to book on wp 44
        self.db.time_wp.set (self.vacation_wp, bookers = [self.user30])
        user30_time.import_data_30 (self.db, self.user30, self.olo)
        self.db.commit ()
    # end def setup_user30

    def test_user30_vacation (self):
        self.log.debug ('test_user30')
        self.setup_db ()
        self.setup_user30 ()
        # Allow report
        rl = self.db.user.get (self.user0, 'roles')
        ...
        self.db.commit ()
        self.db.close  ()
        # First query with a HR user
        self.db = self.tracker.open (self.username0)
        summary.init (self.tracker)
        fs = { 'user': [self.user30], 'date': '2019-01-01;2025-12-31' }
        class r: filterspec = fs ; columns = {'additional_submitted'}
        class c: _ = lambda x: x
        sr = summary.Vacation_Report \
            (self.db, r, templating.TemplatingUtils (c))
        ...
        self.assertEqual (lines  [1] [3], '25.000')
        self.assertEqual (lines  [1] [4], '0.000')
        self.assertEqual (lines  [1] [5], '25.000')
        self.assertEqual (lines  [1] [6], '13.0')
        self.assertEqual (lines  [1] [7], '0.000')
        self.assertEqual (lines  [1] [8], '12.000')
        self.assertEqual (lines  [1] [9], '0.000')
        self.assertEqual (lines  [2] [0], 'testuser30')
        self.assertEqual (lines  [2] [1], '2020-12-31')
        self.assertEqual (lines  [2] [2], '25.000')
        self.assertEqual (lines  [2] [3], '25.000')
        self.assertEqual (lines  [2] [4], '12.000')
        self.assertEqual (lines  [2] [5], '37.000')
        self.assertEqual (lines  [2] [6], '30.0')
        self.assertEqual (lines  [2] [7], '')
        self.assertEqual (lines  [2] [8], '7.000')
        self.assertEqual (lines  [2] [9], '0.000')
        self.assertEqual (lines  [3] [0], 'testuser30')
        self.assertEqual (lines  [3] [1], '2021-12-31')
        self.assertEqual (lines  [3] [2], '25.000')
        self.assertEqual (lines  [3] [3], '25.000')
        self.assertEqual (lines  [3] [4], '7.000')
        self.assertEqual (lines  [3] [5], '32.000')
        self.assertEqual (lines  [3] [6], '27.0')
        self.assertEqual (lines  [3] [7], '')
        self.assertEqual (lines  [3] [8], '5.000')
        self.assertEqual (lines  [3] [9], '0.000')
        self.assertEqual (lines  [4] [0], 'testuser30')
        self.assertEqual (lines  [4] [1], '2022-12-31')
        self.assertEqual (lines  [4] [2], '25.000')
        self.assertEqual (lines  [4] [3], '25.000')
        self.assertEqual (lines  [4] [4], '5.000')
        self.assertEqual (lines  [4] [5], '30.000')
        self.assertEqual (lines  [4] [6], '29.0')
        self.assertEqual (lines  [4] [7], '')
        self.assertEqual (lines  [4] [8], '1.000')
        self.assertEqual (lines  [4] [9], '0.000')
        self.assertEqual (lines  [5] [0], 'testuser30')
        self.assertEqual (lines  [5] [1], '2023-12-31')
        self.assertEqual (lines  [5] [2], '25.000')
        self.assertEqual (lines  [5] [3], '25.000')
        self.assertEqual (lines  [5] [4], '1.000')
        self.assertEqual (lines  [5] [5], '26.000')
        self.assertEqual (lines  [5] [6], '26.0')
        self.assertEqual (lines  [5] [7], '')
        self.assertEqual (lines  [5] [8], '0.000')
        self.assertEqual (lines  [5] [9], '0.000')
        self.assertEqual (lines  [6] [0], 'testuser30')
        self.assertEqual (lines  [6] [1], '2024-12-31')
        self.assertEqual (lines  [6] [2], '25.000')
        self.assertEqual (lines  [6] [3], '25.000')
        self.assertEqual (lines  [6] [4], '0.000')
        self.assertEqual (lines  [6] [5], '25.000')
        self.assertEqual (lines  [6] [6], '23.0')
        self.assertEqual (lines  [6] [7], '')
        self.assertEqual (lines  [6] [8], '2.000')
        self.assertEqual (lines  [6] [9], '0.000')
        self.assertEqual (lines  [7] [0], 'testuser30')
        self.assertEqual (lines  [7] [1], '2025-12-31')
        self.assertEqual (lines  [7] [2], '25.000')
        self.assertEqual (lines  [7] [3], '25.000')
        self.assertEqual (lines  [7] [4], '2.000')
        self.assertEqual (lines  [7] [5], '27.000')
        self.assertEqual (lines  [7] [6], '9.0')
        self.assertEqual (lines  [7] [7], '')
        self.assertEqual (lines  [7] [8], '18.000')
        self.assertEqual (lines  [7] [9], '0.000')
        self.db.close ()

        # Second query with user30
        # The user sees the rounded-up numbers.
        # This in particular tests for rounding errors, there was a bug
        # in consolidated_vacation that return something like
        # 50.00000000000001 for the number of days resulting in a
        # prorated computation of 25.000000000000007 or sometimes
        # 24.999999999999986 -- the consolidated_vacation is now rounded
        # to 10 digits after the decimal point (!) which fixes this.
        self.db = self.tracker.open (self.username30)
        summary.init (self.tracker)
        fs = { 'user': [self.user30], 'date': '2019-01-01;2025-12-31' }
        class r: filterspec = fs ; columns = {'additional_submitted'}
        class c: _ = lambda x: x
        ...
        self.assertEqual (lines  [1] [4], '0.000')
        self.assertEqual (lines  [1] [5], '25.000')
        self.assertEqual (lines  [1] [6], '13.000')
        self.assertEqual (lines  [1] [7], '0.000')
        self.assertEqual (lines  [1] [8], '12.000')
        self.assertEqual (lines  [1] [9], '0.000')
        self.assertEqual (lines  [2] [0], 'testuser30')
        ...
        self.assertEqual (lines  [2] [4], '12.000')
        self.assertEqual (lines  [2] [5], '37.000')
        self.assertEqual (lines  [2] [6], '30.000')
        self.assertEqual (lines  [2] [7], '')
        self.assertEqual (lines  [2] [8], '7.000')
        self.assertEqual (lines  [2] [9], '0.000')
        self.assertEqual (lines  [3] [0], 'testuser30')
        ...
        self.assertEqual (lines  [3] [4], '7.000')
        self.assertEqual (lines  [3] [5], '32.000')
        self.assertEqual (lines  [3] [6], '27.000')
        self.assertEqual (lines  [3] [7], '')
        self.assertEqual (lines  [3] [8], '5.000')
        self.assertEqual (lines  [3] [9], '0.000')
        self.assertEqual (lines  [4] [0], 'testuser30')
        ...
        self.assertEqual (lines  [4] [4], '5.000')
        self.assertEqual (lines  [4] [5], '30.000')
        self.assertEqual (lines  [4] [6], '29.000')
        self.assertEqual (lines  [4] [7], '')
        self.assertEqual (lines  [4] [8], '1.000')
        self.assertEqual (lines  [4] [9], '0.000')
        self.assertEqual (lines  [5] [0], 'testuser30')
        ...
        self.assertEqual (lines  [5] [4], '1.000')
        self.assertEqual (lines  [5] [5], '26.000')
        self.assertEqual (lines  [5] [6], '26.000')
        self.assertEqual (lines  [5] [7], '')
        self.assertEqual (lines  [5] [8], '0.000')
        self.assertEqual (lines  [5] [9], '0.000')
        self.assertEqual (lines  [6] [0], 'testuser30')
        ...
        self.assertEqual (lines  [6] [4], '0.000')
        self.assertEqual (lines  [6] [5], '25.000')
        self.assertEqual (lines  [6] [6], '23.000')
        self.assertEqual (lines  [6] [7], '')
        self.assertEqual (lines  [6] [8], '2.000')
        self.assertEqual (lines  [6] [9], '0.000')
        self.assertEqual (lines  [7] [0], 'testuser30')
        ...
        self.assertEqual (lines  [7] [4], '2.000')
        self.assertEqual (lines  [7] [5], '27.000')
        self.assertEqual (lines  [7] [6], '9.000')
        self.assertEqual (lines  [7] [7], '')
        self.assertEqual (lines  [7] [8], '18.000')
        self.assertEqual (lines  [7] [9], '0.000')
        self.db.close ()
    ...
    def setup_user31 (self):
        self.username31 = 'testuser31'
        self.user31 = self.db.user.create \
            ( username     = self.username31
            , firstname    = 'Nummer31'
            , lastname     = 'User31'
            )
        # Allow user to create their own dyn user rec
        self.db.o_permission.create \
            (user = self.user31, org_location = [self.olo, self.olo2])
        p = self.db.overtime_period.create \
            ( name              = 'monthly average required'
            , months            = 1
            , weekly            = False
        ...
        # allow user31 to book on wp 44
        self.db.time_wp.set (self.vacation_wp, bookers = [self.user31])
        user31_time.import_data_31 (self.db, self.user31, self.olo)
        self.db.commit ()
    # end def setup_user31

    def test_user31_vacation (self):
        self.log.debug ('test_user31')
        self.setup_db ()
        self.setup_user31 ()
        # Allow report
        rl = self.db.user.get (self.user0, 'roles')
        ...
        self.db = self.tracker.open (self.username0)
        summary.init (self.tracker)
        fs = { 'user': [self.user31], 'date': '2023-01-01;2025-12-31' }
        class r: filterspec = fs ; columns = {'additional_submitted'}
        class c: _ = lambda x: x
        sr = summary.Vacation_Report \
            (self.db, r, templating.TemplatingUtils (c))
        ...
        self.assertEqual (lines  [1] [2], '25.000')
        self.assertEqual (lines  [1] [3], '25.000')
        self.assertEqual (lines  [1] [4], '11.943')
        self.assertEqual (lines  [1] [5], '36.943')
        self.assertEqual (lines  [1] [6], '0.0')
        self.assertEqual (lines  [1] [7], '')
        self.assertEqual (lines  [1] [8], '36.943')
        self.assertEqual (lines  [1] [9], '0.000')
        self.assertEqual (lines  [2] [0], 'testuser31')
        self.assertEqual (lines  [2] [1], '2024-12-31')
        self.assertEqual (lines  [2] [2], '0.000')
        self.assertEqual (lines  [2] [3], '10.451')
        self.assertEqual (lines  [2] [4], '0.000')
        self.assertEqual (lines  [2] [5], '10.451')
        self.assertEqual (lines  [2] [6], '0.0')
        self.assertEqual (lines  [2] [7], '0.000')
        self.assertEqual (lines  [2] [8], '10.451')
        self.assertEqual (lines  [2] [9], '0.000')
        self.assertEqual (lines  [3] [0], 'testuser31')
        self.assertEqual (lines  [3] [1], '2025-12-31')
        self.assertEqual (lines  [3] [2], '25.000')
        self.assertEqual (lines  [3] [3], '7.671')
        self.assertEqual (lines  [3] [4], '10.451')
        self.assertEqual (lines  [3] [5], '18.122')
        self.assertEqual (lines  [3] [6], '0.0')
        self.assertEqual (lines  [3] [7], '-7.220 + 3.770')
        self.assertEqual (lines  [3] [8], '14.672')
        self.assertEqual (lines  [3] [9], '0.000')
        self.db.close ()
    # end def test_user31_vacation

    def setup_user32 (self):
        self.username32 = 'testuser32'
        self.user32 = self.db.user.create \
            ( username     = self.username32
            , firstname    = 'Nummer32'
            , lastname     = 'User32'
            )
        # Allow user to create their own dyn user rec
        self.db.o_permission.create \
            (user = self.user32, org_location = [self.olo, self.olo2])
        p = self.db.overtime_period.create \
            ( name              = 'monthly average required'
            , months            = 1
            , weekly            = False
        ...
        # allow user32 to book on wp 44
        self.db.time_wp.set (self.vacation_wp, bookers = [self.user32])
        user32_time.import_data_32 (self.db, self.user32, self.olo)
        self.db.commit ()
    # end def setup_user32

    def test_user32_vacation (self):
        self.log.debug ('test_user32')
        self.setup_db ()
        self.setup_user32 ()
        # Force the carry forward for 2023 to 8.21
        vcorr = self.db.vacation_correction.create \
            ( user     = self.user32
        ...
        self.db = self.tracker.open (self.username0)
        summary.init (self.tracker)
        fs = { 'user': [self.user32], 'date': '2023-01-01;2025-12-31' }
        class r: filterspec = fs ; columns = {'additional_submitted'}
        class c: _ = lambda x: x
        sr = summary.Vacation_Report \
            (self.db, r, templating.TemplatingUtils (c))
        ...
        self.assertEqual (lines  [1] [1], '2023-12-31')
        self.assertEqual (lines  [1] [2], '25.000')
        self.assertEqual (lines  [1] [3], '24.452')
        self.assertEqual (lines  [1] [4], '8.206')
        self.assertEqual (lines  [1] [5], '32.658')
        self.assertEqual (lines  [1] [6], '16.0')
        self.assertEqual (lines  [1] [7], '')
        self.assertEqual (lines  [1] [8], '16.658')
        self.assertEqual (lines  [1] [9], '0.000')
        self.assertEqual (lines  [2] [0], 'testuser32')
        self.assertEqual (lines  [2] [1], '2024-12-31')
        self.assertEqual (lines  [2] [2], '25.000')
        self.assertEqual (lines  [2] [3], '11.954')
        self.assertEqual (lines  [2] [4], '16.658')
        self.assertEqual (lines  [2] [5], '28.612')
        self.assertEqual (lines  [2] [6], '27.0')
        self.assertEqual (lines  [2] [7], '')
        self.assertEqual (lines  [2] [8], '1.612')
        self.assertEqual (lines  [2] [9], '0.000')
        self.assertEqual (lines  [3] [0], 'testuser32')
        self.assertEqual (lines  [3] [1], '2025-12-31')
        self.assertEqual (lines  [3] [2], '25.000')
        self.assertEqual (lines  [3] [3], '25.000')
        self.assertEqual (lines  [3] [4], '1.612')
        self.assertEqual (lines  [3] [5], '26.612')
        self.assertEqual (lines  [3] [6], '2.0')
        self.assertEqual (lines  [3] [7], '')
        self.assertEqual (lines  [3] [8], '24.612')
        self.assertEqual (lines  [3] [9], '0.000')
        self.db.close ()
    ...
    def test_user35_vacation (self):
        ...
        self.assertEqual (lines  [1] [5], '29.570')
        self.assertEqual (lines  [1] [6], '16.0')
        self.assertEqual (lines  [1] [7], '')
        self.assertEqual (lines  [1] [8], '13.570')
        self.db.close ()
        ...
        self.assertEqual (lines  [1] [3], '30.000')
        self.assertEqual (lines  [1] [4], '-0.430')
        self.assertEqual (lines  [1] [5], '30.000')
        self.assertEqual (lines  [1] [6], '16.000')
        self.assertEqual (lines  [1] [7], '')
        self.assertEqual (lines  [1] [8], '14.000')
        self.db.close ()
    # end def test_user35_vacation

    def setup_user36 (self):
        self.username36 = 'testuser36'
        self.user36 = self.db.user.create \
            ( username     = self.username36
            , firstname    = 'Nummer36'
            , lastname     = 'User36'
            )
        # Allow user to create their own dyn user rec
        self.db.o_permission.create \
            (user = self.user36, org_location = [self.olo, self.olo2])
        p = self.db.overtime_period.create \
            ( name              = 'monthly average required'
            , months            = 1
            , weekly            = False
        ...
        # allow user36 to book on wp 44
        self.db.time_wp.set (self.vacation_wp, bookers = [self.user36])
        # allow user36 to book on wp 1 (public holiday)
        self.db.time_wp.set (self.holiday_wp, bookers = [self.user36])
        self.monkey_patch_pub_holiday_reactors ()
        self.monkey_patch_auto_wp_auditors ()
        self.create_public_holidays (date.Date ('2022-01-01'))
        # Need to import data *after* creating public holidays
        user36_time.import_data_36 (self.db, self.user36, self.olo, self)
        self.restore_monkey_patched_detectors ()
        self.db.commit ()
    # end def setup_user36

    def test_user36_vacation (self):
        self.log.debug ('test_user36')
        self.setup_db ()
        self.setup_user36 ()
        # Allow report
        rl = self.db.user.get (self.user0, 'roles')
        ...
        self.db.commit ()
        self.db.close  ()
        # Get vacation data for 2026 for this user *as this user*
        self.db = self.tracker.open (self.username36)
        #          eoy, approved, submitted, remaining (incl subm)
        expect = ( (16, 0,       16,         0)
                 , (13, 0,        4,         9)
                 )
        dt    = date.Date ('2026-12-31')
        jandt = date.Date ('2026-01-01')
        for n, ctid in enumerate ((None, '1')):
            eoy  = eoy_vacation \
            ...
            rem  = remaining_vacation \
                (self.db, self.user36, ctid, dt) - vsub
            print (eoy, vapr, vsub, rem)
            assert eoy  == expect [n][0]
            assert vapr == expect [n][1]
            assert vsub == expect [n][2]
    ...
    def test_user37_vacation (self):
        ...
        self.assertEqual (lines  [1] [5], '22.781')
        self.assertEqual (lines  [1] [6], '23.0')
        self.assertEqual (lines  [1] [7], '')
        self.assertEqual (lines  [1] [8], '-0.219')
        ...
        self.assertEqual (lines  [1] [3], '25.000')
        self.assertEqual (lines  [1] [4], '-2.219')
        self.assertEqual (lines  [1] [5], '23.000')
        self.assertEqual (lines  [1] [6], '23.000')
        self.assertEqual (lines  [1] [7], '')
        self.assertEqual (lines  [1] [8], '0.000')
