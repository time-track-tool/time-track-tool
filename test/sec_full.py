...
Role "it":
 ...
 User is allowed Edit on (Edit for "user": ('address', 'alternate_addresses', 'nickname', 'password', 'timezone', 'username') only)
 User is allowed Edit on (Edit for "user": ('aux_username', 'group', 'home_directory', 'is_lotus_user', 'login_shell', 'pictures', 'samba_home_drive', 'samba_home_path', 'samba_kickoff_time', 'samba_lm_password', 'samba_logon_script', 'samba_nt_password', 'samba_profile_path', 'samba_pwd_can_change', 'samba_pwd_last_set', 'samba_pwd_must_change', 'secondary_groups', 'shadow_expire', 'shadow_inactive', 'shadow_last_change', 'shadow_max', 'shadow_min', 'shadow_used', 'shadow_warning', 'sync_with_ldap', 'uid', 'user_password') only)
 User is allowed Edit on (Edit for "user": ('contacts',) only)
 User is allowed Edit on (Edit for "user_contact": ('contact', 'contact_type', 'description', 'order', 'user') only)
...
Role "user":
 ...
 User is allowed to search time_wp (Search for "time_wp": ('activity', 'actor', 'cost_center', 'creation', 'creator', 'description', 'durations_allowed', 'epic_key', 'has_expiration_date', 'is_public', 'id', 'name', 'project', 'responsible', 'time_end', 'time_start', 'time_wp_summary_no', 'travel', 'wp_no') only)
